#!/usr/bin/env python3
"""
ALLSHORES Executive Boardroom - AV Rack Elevation (Rev. 1).
...
LAYOUT = [
    ...
    (16, 1, "NETGEAR M4250-16XF", "16x SFP+ FIBER SWITCH  (1 OF 2)", "gear"),
    (15, 1, "NETGEAR M4250-16XF", "16x SFP+ FIBER SWITCH  (2 OF 2)", "gear"),
...
s.notes([
    ...
    "4.  M4250-16XF IS ALL-FIBER SFP+ WITH NO COPPER PoE PORTS. THE MICS, CAMERAS, NVX ENDPOINTS,",
    "     TOUCH PANEL AND THINKSMART CORE ALL NEED COPPER PoE - NO PoE SWITCH IS ON THE LIST. CONFIRM.",
    ...
    "7.  PATCH PANEL SHOWN 24 PORT. CONFIRM DROP COUNT - A 48 PORT 2U MAY BE NEEDED.",
